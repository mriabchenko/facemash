...
export class TransportService {
    ...
    private participants$: BehaviorSubject<ParticipantModel[]>;
    ...
    public constructor(private afs: AngularFirestore, private helper: HelperService) {
        ...
        this.participants$ = new BehaviorSubject<ParticipantModel[]>([]); // initial number (it doesn't effect something)
     ...
     * @returns {BehaviorSubject<ParticipantModel[]>}
     */
    public getParticipants(): BehaviorSubject<ParticipantModel[]> {
